' ***************************************************************************
' 
' This script scales the screen with the monitors CPU (display)
' to stretched full screen
' Dieses Skript lässt den Bildschirm mit der Monitor-CPU (Anzeige)
...
' OS: Windows XP+
' Hardware: should be every PC that has a monitor
' (drivers haven't to be installed)
